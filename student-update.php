    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input value="<?php echo $row['student_id']; ?>"  class="input--style-4" type="text" name="student_id" disabled="disabled">
              </div>
            </div>
            <div class="col-md-4">
              <div class="input-group">
        ...
        <div  class="row">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input value="<?php echo $row['email']; ?>" class="input--style-4" type="text" name="email"disabled="disabled">
              </div>
            </div>
            <div class="col-md-4">
              <div class="input-group">
        ...
        <div class="p-t-15">
            ...
            <a href="student.php"> Goto Profile</a>
        </div>
